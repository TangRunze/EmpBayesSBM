function [errorRateMap, tauMap, tauConfidence, tauResult] = ...
    mcmc2chains(nVertex, nBlock, dimLatentPosition, adjMatrix, muHat, ...
    sigmaHat, tauHat, pTauHat, rho, tauStar, nuStar, sigmaStar, theta, ...
    nBurnIn, nConverge, scaleCovariance, modelType, isHomophily, ...
    isIdentifiable)
...
tauConfidence = sum(tauResult == repmat(tauMap, 2*nConverge, 1))/2/...
    nConverge;
