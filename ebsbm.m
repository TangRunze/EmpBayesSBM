        ...
        if exist(saveFile, 'file') == 0
            if (modelType == 1) || (scaleCovariance == 5)
                [errorRate, tau, tauConfidence, tauResult] = ...
                    ...
                    adjMatrix, muHat, sigmaHat, tauHat, 0, tauStar, 0, ...
                    0, theta, nBurnIn, nConverge*2, scaleCovariance, ...
                    modelType, isHomophily, isIdentifiable);
            else
                [errorRate, tau, tauConfidence, tauResult] = ...
                    mcmc2chains(nVertex, nBlock, dimLatentPosition, ...
                    adjMatrix, muHat, sigmaHat, tauHat, pTauHat, 0, ...
                    tauStar, 0, 0, theta, nBurnIn, nConverge, ...
                    scaleCovariance, modelType, isHomophily, ...
                    isIdentifiable);
            end
            parsave(saveFile, errorRate, tau, tauConfidence, tauResult);
        end
    end
end
